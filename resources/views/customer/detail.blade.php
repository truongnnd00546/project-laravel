            ...
            <div class="col-md-4 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        ...
                        <ul class="slides"
                            style="width: 1000%; transition-duration: 0.6s; transform: translate3d(-844px, 0px, 0px);">
                            <li data-thumb="{{asset('asset/images/d3.jpg')}}" class="clone" aria-hidden="true"
                                style="width: 422px; float: left; display: block;">
                                <div class="thumb-image"><img src="{{asset('asset/images/d3.jpg')}}"
                                                              data-imagezoom="true" class="img-responsive"
                                                              draggable="false"></div>
                            </li>
                            <li data-thumb="{{asset('asset/images/d2.jpg')}}"
                                style="width: 422px; float: left; display: block;"
                                class="flex-active-slide">
                                <div class="thumb-image"><img src="{{asset('asset/images/d2.jpg')}}"
                                                              data-imagezoom="true" class="img-responsive"
                                                              draggable="false"></div>
                            </li>
                            <li data-thumb="{{asset('asset/images/d1.jpg')}}" class=""
                                style="width: 422px; float: left; display: block;">
                                <div class="thumb-image"><img src="{{asset('asset/images/d1.jpg')}}"
                                                              data-imagezoom="true" class="img-responsive"
                                                              draggable="false"></div>
                            </li>
                        ...
                        <ol class="flex-control-nav flex-control-thumbs">
                            {{--<li><img src="{{asset('asset/images/d2.jpg')}}" class="" draggable="false"></li>--}}
                            {{--<li><img src="{{asset('asset/images/d1.jpg')}}" draggable="false" class="flex-active"></li>--}}
                            {{--<li><img src="{{asset('asset/images/d3.jpg')}}" draggable="false" class=""></li>--}}
                            {{--</ol>--}}
                ...
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                    ...
                    <div class="resp-tabs-container">
                        ...
                        <h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span
                                    class="resp-arrow"></span>Description</h2>
                        ...
                        <h2 class="resp-accordion" role="tab" aria-controls="tab_item-2"><span
                                    class="resp-arrow"></span>Information</h2>
